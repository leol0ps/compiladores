...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_18_if_stmt = 18,                /* if-stmt  */
  YYSYMBOL_exp = 19                        /* exp  */
};
...
static const char *const yytname[] =
{
  ...
  "ENTER", "TIMES", "OVER", "MINUS", "LPAR", "RPAR", "OTHER", "IF", "ELSE",
  "TRUE", "FALSE", "$accept", "statement", "if-stmt", "exp", YY_NULLPTR
};
...
{
      11,     6,    13,     1,     2,     7,     8,     5,    12,    10
};

static const yytype_int8 yycheck[] =
{
      10,     0,    12,    11,    12,    14,    15,     9,    13,    10
};
